...
const HREF_SP = `${BASE}?utm_source=delver&utm_medium=banner&utm_campaign=blog&utm_content=floating_sp`
const HREF_PC = `${BASE}?utm_source=delver&utm_medium=banner&utm_campaign=blog&utm_content=floating_pc`
